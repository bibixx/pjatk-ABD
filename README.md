<h1 align="center">
  ...
  ABD exercises solutions
</h1>

This repository contains solutions to the exercises for the ABD (Database Administration) PostgreSQL course led by Piotr Gago during studies on [PJAIT](https://www.pja.edu.pl/en/).
